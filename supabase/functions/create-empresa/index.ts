...
Deno.serve(async (req) => {
  ...
  try {
    ...
    const { email, password, nome_empresa, nome_dono, telefone, data_inicio, data_termino } = body;
    ...
    // 2. Cria perfil em public.usuarios
    ...
    // 3. Aguarda consistência
    await new Promise(r => setTimeout(r, 300));
 
    // 4. Cria a empresa (com telefone)
