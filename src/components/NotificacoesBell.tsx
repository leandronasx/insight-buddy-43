      ...
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            className="absolute right-0 sm:-right-0 -right-16 top-full mt-2 w-screen max-w-[360px] sm:w-96 sm:max-w-none bg-card border border-border rounded-xl shadow-xl z-50 overflow-hidden"
          >
            {/* Header */}
